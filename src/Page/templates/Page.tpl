...
<script type="text/javascript" src="<?php echo $link['JS_LINK'] ?>"<?php if (!empty($link['INTEGRITY'])) : ?> integrity="<?php echo $link['INTEGRITY'] ?>"<?php endif; ?><?php if (!empty($link['CROSSORIGIN'])) : ?> crossorigin="<?php echo $link['CROSSORIGIN'] ?>"<?php endif; ?>></script>
<?php endforeach ?>
<?php endif ?>
